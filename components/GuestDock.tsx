    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-[90] animate-fade-in-up flex justify-center">
      <div className="h-[5.8rem] w-full max-w-md relative">
        ...
        <div className="relative h-full flex items-start justify-around px-2 pt-1">
            ...
            <>
                <DockItem icon={MapPin} label="UBI" onClick={handleUbiClick} />
                <div className="relative -top-6 z-30 flex flex-col items-center">
                    ...
                    <span className={`block text-center text-[10px] font-black tracking-widest uppercase mt-2 transition-colors ${isMusicPlaying ? 'text-amber-500' : 'text-gray-500'}`}>VIBE</span>
                </div>
                <DockItem icon={MessageCircle} label="CHAT" onClick={handleContactOrganizer} />
            </>
            )}
